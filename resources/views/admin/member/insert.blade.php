            ...
            <div class="row gap-3">
                <form action="/dashboard/member" method="post">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('kode_member') is-invalid @enderror" name="kode_member" id="kode_member" placeholder="Masukan kode member..." value="{{ old('kode_member') }}">
                            @error('kode_member')
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('nomor') is-invalid @enderror" name="nomor" id="nomor" placeholder="Masukan no telepon.." value="{{ old('nomor') }}">
                            @error('nomor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="/dashboard/memb er"><button class="btn btn-wide btn-danger shadow me-3" type="cancel">Batal</button></a>
